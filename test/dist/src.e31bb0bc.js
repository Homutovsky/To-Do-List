...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/nodes.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.mainBtn = exports.list = exports.getInput = void 0;
var mainBtn = document.querySelector('.main-button');
exports.mainBtn = mainBtn;
var getInput = document.querySelector('.main-input');
...
function createLi(id) {
  ...
  var li = createElement('li', 'item', '', id);
  var label = createElement('label');
  var input = createElement('input', 'checkbox', 'cross', '', 'checkbox');
  var button = createElement('button', 'checkbox-close', 'remove');
  var div = createElement('div', 'checkbox-block');
...
},{}],"js/initialRender.js":[function(require,module,exports) {
"use strict";
...
function render() {
  ...
  var todoItems = todos.map(function (item) {
    var li = (0, _create.createLi)(item.id, item.discription, item.isCompleted);
    return li;
  });

  _nodes.list.append.apply(_nodes.list, _toConsumableArray(todoItems));
}
},{"./nodes.js":"js/nodes.js","./create.js":"js/create.js"}],"../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
var _initialRender = require("./js/initialRender.js");

require("_bundle_loader")(require.resolve('./js/appEventListener.js'));

(0, _initialRender.render)();
},{"./js/initialRender.js":"js/initialRender.js","_bundle_loader":"../node_modules/parcel-bundler/src/builtins/bundle-loader.js","./js/appEventListener.js":[["appEventListener.5a6d39f2.js","js/appEventListener.js"],"appEventListener.5a6d39f2.js.map","js/appEventListener.js"]}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
